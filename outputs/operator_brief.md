...
DealFlowAgent gets a local, deterministic pressure test around ai-native, depends, and remembering. The useful part is not the dashboard; it is the repeatable evidence path from fixture to failure to operator action.
